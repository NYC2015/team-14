    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <p>6 lbs.</p>
                            <p><a data-toggle="modal" data-target="#vendorprofile">Whole Foods</a></p>
                            <button class="btn btn-primary" data-toggle="modal" data-target="#reservefood">Reserve!</button>
                        </div>
                    </div>
                ...
                <div id="vendorprofile" class="modal fade" role="dialog">
                ...
                <div id="reservefood" class="modal fade" role="dialog">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="input-append date form_datetime" data-date="2015-10-17T05:25:07Z" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input1">
